...
entity udp_checksum_gen is
    generic(
        PAYLOAD_FIFO_ADDR_WIDTH: integer := 11;
        HEADER_FIFO_ADDR_WIDTH: integer := 3
    );
    port(
        clk             : in     vl_logic;
        rst             : in     vl_logic;
    ...
    attribute mti_svvh_generic_type of PAYLOAD_FIFO_ADDR_WIDTH : constant is 1;
    attribute mti_svvh_generic_type of HEADER_FIFO_ADDR_WIDTH : constant is 1;
end udp_checksum_gen;
