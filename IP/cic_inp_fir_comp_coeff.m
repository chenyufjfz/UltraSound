...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% cic_inp_fir_comp_coeff genearats CIC compensation filter coefficients
% using frequency sampling method.
%
%    cic_inp_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B) calculates compensation
...
%
%    Examples:
%    cic_inp_fir_comp_coeff(31,80e6,4e6,true,true,16);
%    cic_inp_fir_comp_coeff(31,80e6,4e6,true,false)


function cic_inp_fir_comp_coeff(L, Fs, Fc, plot, is_fxp, B)
try
	% Validate number of input arguments
	error(nargchk(0, 6, nargin));

	%%%%%% CIC filter parameters %%%%%%
	R = 4096;					%% Interpolation factor
	...
	filename = 'cic_inp_fir_comp_coeff.txt';
